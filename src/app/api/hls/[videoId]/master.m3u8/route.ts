...
import { type PlaylistCredential, rewriteMasterPlaylist } from "@/lib/hls/playlist";
...
export async function GET(
    ...
    // Build the credential to embed in rewritten variant URIs.
    ...
    let body: string;
    try {
        body = await rewriteMasterPlaylist(videoId, credential);
    } catch {
