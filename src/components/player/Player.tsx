...
export const Player = ({
    ...
    const autoLabels = new Set(
        captions.filter((c) => c.isAutoGenerated).map((c) => c.label),
    );
...
const PlayerInner = ({
    ...
    tokenQS: _tokenQS,
}: Omit<PlayerProps, "captions" | "signedToken" | "autoplay" | "muted" | "loop" | "startSec"> & { tokenQS: string; controls?: "auto" | "hidden" }) => {
