...
export const videoCaptions = pgTable(
    "video_captions",
    {
        ...
        // Auto-generated captions (Whisper, future-fancy STT). Same source
        // bucket as sidecars on disk but distinguished here so the UI can
        // surface "auto" affordances and the operator can re-run / overwrite.
